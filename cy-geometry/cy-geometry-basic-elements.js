...
export function createDrawElement(type, data ) {
    ...
    switch (type) {
        ...
        case 'circle':
            ...
            break;
        case 'polygon': //subtipos H y R (lado o vértice)
            if(data.cx === undefined){
                data.cx = data.x0; data.cy = data.y0
            }
            ...
            if(data.subType === 'H'){ //nos dan el inscrito
        ...
        case 'arc':
            ...
            switch(data.subType){
                ...
                case '3P':{//llegan p0, pm, p1, Atton
                    let arc;
                    if(data.x1 !== undefined) //al loro porque el if a pelo salta con el 0!!!
