    ...
    function parsePath(d) {
        ...
        commands.forEach((cmd) => {
            ...
            switch (c) {
                ...
                case "l":
                    while (cmd.length !== 0) {
                        //esto sería polylínea
                        rx = +cmd.shift();
                        ry = +cmd.shift(); //el + es para forzar a número
                        if (inc) {
                            rx += cpx;
                            ry += cpy;
                        }
                ...
                case "c": //cubic bezier, pueden venir varias pero son independientes
                    ...
                    while (cmd.length !== 0) {
                        ...
                        if (inc) {
                            ctrl[0] += cpx;
                            ctrl[1] += cpy; //control point 1
                            ctrl[2] += cpx;
                            ctrl[3] += cpy; //control point 2
                            ctrl[4] += cpx;
                ...
                case "s":
                    ...
                    while (cmd.length !== 0) {
                        ...
                        if (inc) {
                            ctrl[0] += cpx;
                            ctrl[1] += cpy; //control point 2, el 1 se calcula con este y cpx,cpy
                            ctrl[2] += cpx;
                ...
                case "q":
                    ...
                    while (cmd.length !== 0) {
                        ...
                        ); //a ver cómo lo distinguimos en el constructor por la longitud de lo pasado
                        [cpx, cpy] = [ctrl[2], ctrl[3]];
                    }
                    break;
                ...
                case "t":
                    ...
                    while (cmd.length !== 0) {
                        ...
                        ); //a ver cómo lo distinguimos en el constructor
