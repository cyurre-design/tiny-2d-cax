...
import { inputDataInit, initialDataBasic, inputDataUpdate, inputDataSubtype, setEventHandlers, TX0Y0, TX1Y1 } from "./cy-input-data-templates.js";
export default class CyInputDataMeasure extends HTMLElement {
	...
	set subType(type) {
		...
		["measure-block", "measure-p2p"].forEach((el) => (this.dom.querySelector("#" + el).style.display = "none"));
