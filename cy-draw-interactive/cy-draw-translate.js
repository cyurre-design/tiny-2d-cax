    ...
    export default class DrawTranslate extends DrawBasic{
        ...
        //         detail:{pos:this.hit, type:'translate', subType: this.subMode, idn:this.dataSent[this.status]}}));
        // };
        //Habría que chequear tipos numéricos y tal, formatos...
        updateData= (data)=>{
            const newData = super.updateData(data); //Esto pone las propiedades de forma genérica
            console.log(newData);
            ...
            //             //case 'int' : ; break;
            //         }
            //     } else if(this.dataReceived.includes(idn))
            //         this.data[idn] = data[k];
            //         if((idn === 'x0') || (idn === 'y0')) p0({x:this.data.x0 , y:this.data.y0});
